            ...
            <div className="px-6 mt-6 space-y-8">
                {loadingProgress >= 0 ? (
                    <div className="flex flex-col justify-center items-center py-20 space-y-4">
                        <span className="text-3xl font-bold text-emerald-700 dark:text-qareeb-accent">{loadingProgress}%</span>
                        ...
                        <div className="w-48 h-2 bg-gray-200 dark:bg-white/10 rounded-full overflow-hidden">
                            <div
                                className="h-full bg-emerald-600 dark:bg-qareeb-accent rounded-full transition-all duration-300 ease-out"
